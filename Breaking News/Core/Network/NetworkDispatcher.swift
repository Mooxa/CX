...
//    func request<ReturnType: Decodable>(request: URLRequest, completion: @escaping (Result<ReturnType,NetworkRequestError>) -> Void) {
//        
//        let decoder = JSONDecoder()
...
//                    do {
//                        let decodedData = try decoder.decode(ReturnType.self, from: safeData)
//                        print(decodedData)
